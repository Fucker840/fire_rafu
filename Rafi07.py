...
for xd in range(10000):
        aa='Mozilla/5.0 (Linux; Android 12; motorola edge 20 Build/S1RGS32.53-18-22-15)'
        b=random.choice(['6','7','8','9','10','11','12','13'])
        c=f' TL-tl; {str(gt)}'
        g='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/109.0.5414.117'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/537.36 GNews Android/2022116172'
